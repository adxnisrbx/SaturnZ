...
function Library:CreateWindow()
	...
	local SaturnZ = Instance.new("ScreenGui")
	...
	PearXLogo_1.Parent = LogoHolder_1
	...
	PearXLogo_1.Position = UDim2.new(0.5, 0,0.5, 0)
	PearXLogo_1.Size = UDim2.new(0, 37,0, 37)
	...
	UITog_1.Image = "rbxassetid://15419040715"
	...
	local PearXLogo_2 = Instance.new("ImageLabel")
	...
	PearXLogo_2.Name = "PearXLogo"
	PearXLogo_2.Parent = LogoAndTitleHolder_1
	PearXLogo_2.AnchorPoint = Vector2.new(0.5, 0.5)
	PearXLogo_2.BackgroundColor3 = Color3.fromRGB(255,255,255)
	PearXLogo_2.BackgroundTransparency = 1
	PearXLogo_2.BorderColor3 = Color3.fromRGB(0,0,0)
	PearXLogo_2.BorderSizePixel = 0
	PearXLogo_2.Position = UDim2.new(0.185223803, 0,0.454545468, 0)
	PearXLogo_2.Size = UDim2.new(0, 34,0, 34)
	PearXLogo_2.Image = "rbxassetid://15419040715"
	...
	UpdateDate_1.Text = "- Nov 21/12/2023"
	...
	UpdateMainText_1.Text = "[+] Features : <br />- Color Change!<br />- No Key System!<br />- Quick Hacks!<br />- More Games!<br /> <br /> <br /># By AdxnisRBX"
	...
	YouTubeBtn_1.MouseButton1Click:Connect(function()
		setclipboard(" https://youtube.com/@DiscordMovieTheatre")
	end)
	...
	ImageLogo_1.Image = "rbxassetid://15419040715"
	...
	DiscordBtn_1.MouseButton1Click:Connect(function()
		setclipboard("https://discord.com/invite/9xtt5hqkhV")
	end)
	...
	function Tabs:CreateTab(TabName,IconID)
		...
		function Sections:CreateSection()
			...
			function Elements:CreateButton(ButtonText,Callback)
				...
				local targetButtonColorOn = Color3.fromRGB(210,210,210)
				...
				ButtonBtn_1.TextColor3 = Color3.fromRGB(20,20,20)
			...
			function Elements:CreateToggle(ToggleText,Callback)
				...
				ToggleBtn_1.TextColor3 = Color3.fromRGB(20,20,20)
			...
			function Elements:CreateSlider(SliderText,max,Callback)
				...
				SliderTxt_1.TextColor3 = Color3.fromRGB(20,20,20)
				...
				ValueTxt_1.Text = "0"
				ValueTxt_1.TextColor3 = Color3.fromRGB(20,20,20)
			...
			function Elements:CreateLabel(LabelText)
				...
				LabelTxt_1.TextColor3 = Color3.fromRGB(20,20,20)
			...
			function Elements:CreateBox(BoxText,Callback)
				...
				BoxTxt_1.Text = "Box"
				BoxTxt_1.TextColor3 = Color3.fromRGB(20,20,20)
				...
				TextBox_1.PlaceholderColor3 = Color3.fromRGB(20,20,20)
				TextBox_1.PlaceholderText = "..."
				TextBox_1.Text = ""
				TextBox_1.TextColor3 = Color3.fromRGB(20,20,20)
